sap.ui.define([
	...
	return BaseController.extend("productsinventory.controller.Worklist", {
        ...
        _createFilterByTabKey: function(sKey){
            switch(sKey) {
                ...
                case "Low":
                    return new Filter("price", FilterOperator.BT, 1, 15);
                case "Shortage":
                    return new Filter("price", FilterOperator.LE, 0);
                default: 
                return [];
            }
        },
